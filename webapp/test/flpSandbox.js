		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI-Table",
									"targetURL": "#uitableuitable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uitableuitable-display": {
								"semanticObject": "uitableuitable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=uitable.uitable",
									"url": sap.ui.require.toUrl("uitable/uitable")
								}
							}
						}
					}
